...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
        ...
        return (
            <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-primary)', color: 'var(--text-primary)', padding: '2rem', textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
                    <Link href="/login?callbackUrl=/owner-portal-5412" style={{ padding: '0.75rem 1.5rem', background: 'var(--accent)', color: '#fff', borderRadius: '6px', textDecoration: 'none', fontWeight: 600 }}>
                        Sign in as Admin
                    </Link>
    ...
    const navItems = [
        { name: 'Dashboard', path: '/owner-portal-5412', icon: '📊' },
        { name: 'All Orders', path: '/owner-portal-5412/orders', icon: '📦' },
        { name: 'Products', path: '/owner-portal-5412/products', icon: '✨' },
        { name: 'Categories', path: '/owner-portal-5412/categories', icon: '📁' },
