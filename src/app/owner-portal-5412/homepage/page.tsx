...
export default function EditHomepage() {
    ...
    const fetchConfig = async () => {
        try {
            ...
            if (res.ok) {
                ...
                setShippingPrice(data.shippingPrice !== undefined ? String(data.shippingPrice) : '');
                setFreeShippingThreshold(data.freeShippingThreshold !== undefined ? String(data.freeShippingThreshold) : '');
                setPromoText(data.promoText || '');
                setShowPromo(data.showPromo ?? true);
                ...
                setHeroScentFinderButtonText(data.heroScentFinderButtonText || '');
                setShowHero(data.showHero ?? true);

                setMarqueeText(data.marqueeText || '');
                setShowMarquee(data.showMarquee ?? true);

                setSaleLabel(data.saleLabel || '');
                setSaleTitle(data.saleTitle || '');
                setSaleSubtitle(data.saleSubtitle || '');
                setShowSale(data.showSale ?? true);

                setExploreTitle(data.exploreTitle || '');
                setExploreSubtitle(data.exploreSubtitle || '');
                setShowExplore(data.showExplore ?? true);

                setSignatureTitle(data.signatureTitle || '');
                setSignatureSubtitle(data.signatureSubtitle || '');
                setSignatureButtonText(data.signatureButtonText || '');
                setShowSignature(data.showSignature ?? true);

                setStoryLabel(data.storyLabel || '');
                setStoryTitle(data.storyTitle || '');
                setStoryDescription(data.storyDescription || '');
                setStoryButtonText(data.storyButtonText || '');
                setShowStory(data.showStory ?? true);

                setTestimonialsTitle(data.testimonialsTitle || '');
                setTestimonialsSubtitle(data.testimonialsSubtitle || '');
    ...
    return (
        <div style={{ maxWidth: '1000px' }}>
            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: '2.5rem', marginBottom: '0.5rem' }}>Edit Homepage</h1>
            <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', fontSize: '0.9rem' }}>
                All text fields below are optional. Erase any text field to hide that specific text/heading on your storefront!
            </p>
                ...
                <div style={{ background: 'var(--bg-secondary)', padding: '2rem', border: '1px solid var(--border-color)', borderRadius: '8px', marginBottom: '2rem' }}>
                    ...
                    <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                        ...
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                ...
                                <input type="text" value={card1Name} onChange={(e) => setCard1Name(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Edition / Subtitle</label>
                                <input type="text" value={card1Edition} onChange={(e) => setCard1Edition(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Image URL</label>
                                <input type="text" value={card1Image} onChange={(e) => setCard1Image(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Target Link / Page URL</label>
                                <input type="text" value={card1Link} onChange={(e) => setCard1Link(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                        ...
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Name</label>
                                <input type="text" value={card2Name} onChange={(e) => setCard2Name(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Edition / Subtitle</label>
                                <input type="text" value={card2Edition} onChange={(e) => setCard2Edition(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Image URL</label>
                                <input type="text" value={card2Image} onChange={(e) => setCard2Image(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Target Link / Page URL</label>
                                <input type="text" value={card2Link} onChange={(e) => setCard2Link(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ paddingBottom: '0.5rem' }}>
                        ...
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Name</label>
                                <input type="text" value={card3Name} onChange={(e) => setCard3Name(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Edition / Subtitle</label>
                                <input type="text" value={card3Edition} onChange={(e) => setCard3Edition(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Image URL</label>
                                <input type="text" value={card3Image} onChange={(e) => setCard3Image(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Target Link / Page URL</label>
                                <input type="text" value={card3Link} onChange={(e) => setCard3Link(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                    </div>
                ...
                <div style={{ background: 'var(--bg-secondary)', padding: '2rem', border: '1px solid var(--border-color)', borderRadius: '8px', marginBottom: '2.5rem' }}>
                    ...
                    <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="text" value={split1Title} onChange={(e) => setSplit1Title(e.target.value)} className={styles.input} />
                        </div>
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Image URL</label>
                                <input type="text" value={split1Image} onChange={(e) => setSplit1Image(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Target Link</label>
                                <input type="text" value={split1Link} onChange={(e) => setSplit1Link(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className={styles.formGroup}>
                            <label className={styles.label}>Title</label>
                            <input type="text" value={split2Title} onChange={(e) => setSplit2Title(e.target.value)} className={styles.input} />
                        </div>
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Image URL</label>
                                <input type="text" value={split2Image} onChange={(e) => setSplit2Image(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Target Link</label>
                                <input type="text" value={split2Link} onChange={(e) => setSplit2Link(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ background: 'var(--bg-secondary)', padding: '2rem', border: '1px solid var(--border-color)', borderRadius: '8px', marginBottom: '2rem' }}>
                    ...
                    {showHero && (
                        <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                            ...
                            <div className={styles.formGroup}>
                                ...
                                <textarea value={heroSubtitle} onChange={(e) => setHeroSubtitle(e.target.value)} className={styles.textarea} rows={2} />
                            </div>
                            <div className={styles.formRow}>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Shop Button Text</label>
                                    <input type="text" value={heroButtonText} onChange={(e) => setHeroButtonText(e.target.value)} className={styles.input} />
                                </div>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Scent Finder Button Text</label>
                                    <input type="text" value={heroScentFinderButtonText} onChange={(e) => setHeroScentFinderButtonText(e.target.value)} className={styles.input} />
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {showMarquee && (
                        <div className={styles.formGroup} style={{ marginTop: '1rem' }}>
                            ...
                            <input type="text" value={marqueeText} onChange={(e) => setMarqueeText(e.target.value)} className={styles.input} />
                        </div>
                    )}
                </div>
                            ...
                            <>
                                <div className={styles.formRow}>
                                    <div className={styles.formGroup}>
                                        ...
                                        <input type="text" value={saleLabel} onChange={(e) => setSaleLabel(e.target.value)} className={styles.input} />
                                    </div>
                                    <div className={styles.formGroup}>
                                        <label className={styles.label}>Section Title</label>
                                        <input type="text" value={saleTitle} onChange={(e) => setSaleTitle(e.target.value)} className={styles.input} />
                                    </div>
                                </div>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Section Subtitle / Description</label>
                                    <input type="text" value={saleSubtitle} onChange={(e) => setSaleSubtitle(e.target.value)} className={styles.input} />
                                </div>
                            </>
                        )}
                    </div>
                    ...
                    <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                        ...
                        {showExplore && (
                            <div className={styles.formRow}>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Section Title</label>
                                    <input type="text" value={exploreTitle} onChange={(e) => setExploreTitle(e.target.value)} className={styles.input} />
                                </div>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Section Subtitle</label>
                                    <input type="text" value={exploreSubtitle} onChange={(e) => setExploreSubtitle(e.target.value)} className={styles.input} />
                                </div>
                            </div>
                        )}
                    </div>
                        ...
                        {showSignature && (
                            <>
                                <div className={styles.formRow}>
                                    <div className={styles.formGroup}>
                                        <label className={styles.label}>Section Title</label>
                                        <input type="text" value={signatureTitle} onChange={(e) => setSignatureTitle(e.target.value)} className={styles.input} />
                                    </div>
                                    <div className={styles.formGroup}>
                                        <label className={styles.label}>Button Text</label>
                                        <input type="text" value={signatureButtonText} onChange={(e) => setSignatureButtonText(e.target.value)} className={styles.input} />
                                    </div>
                                </div>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Section Subtitle</label>
                                    <input type="text" value={signatureSubtitle} onChange={(e) => setSignatureSubtitle(e.target.value)} className={styles.input} />
                                </div>
                            </>
                        )}
                    </div>
                            ...
                            <>
                                <div className={styles.formRow}>
                                    <div className={styles.formGroup}>
                                        ...
                                        <input type="text" value={storyLabel} onChange={(e) => setStoryLabel(e.target.value)} className={styles.input} />
                                    </div>
                                    <div className={styles.formGroup}>
                                        <label className={styles.label}>Story Title</label>
                                        <input type="text" value={storyTitle} onChange={(e) => setStoryTitle(e.target.value)} className={styles.input} />
                                    </div>
                                </div>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Story Description Text</label>
                                    <textarea value={storyDescription} onChange={(e) => setStoryDescription(e.target.value)} className={styles.textarea} rows={3} />
                                </div>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>PHILOSOPHY Link Button Text</label>
                                    <input type="text" value={storyButtonText} onChange={(e) => setStoryButtonText(e.target.value)} className={styles.input} />
                                </div>
                            </>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {showTestimonials && (
                            <div className={styles.formRow}>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Section Title</label>
                                    <input type="text" value={testimonialsTitle} onChange={(e) => setTestimonialsTitle(e.target.value)} className={styles.input} />
                                </div>
                                <div className={styles.formGroup}>
                                    <label className={styles.label}>Section Subtitle</label>
                                    <input type="text" value={testimonialsSubtitle} onChange={(e) => setTestimonialsSubtitle(e.target.value)} className={styles.input} />
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <div style={{ background: 'var(--bg-secondary)', padding: '2rem', border: '1px solid var(--border-color)', borderRadius: '8px', marginBottom: '2.5rem' }}>
                    ...
                    <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                        ...
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                ...
                                <input type="number" value={shippingPrice} onChange={(e) => setShippingPrice(e.target.value)} className={styles.input} />
                            </div>
                            <div className={styles.formGroup}>
                                <label className={styles.label}>Free Shipping Threshold (PKR)</label>
                                <input type="number" value={freeShippingThreshold} onChange={(e) => setFreeShippingThreshold(e.target.value)} className={styles.input} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="text" value={promoText} onChange={(e) => setPromoText(e.target.value)} className={styles.input} />
                        </div>
                    ...
                    <div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="text" value={whatsappNumber} onChange={(e) => setWhatsappNumber(e.target.value)} className={styles.input} />
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '1rem' }}>
